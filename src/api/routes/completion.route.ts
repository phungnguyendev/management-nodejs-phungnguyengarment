...
router.post(
  ...
  validationRules([
    ...
    { field: 'quantityIroned', type: 'int', location: 'body' },
    { field: 'quantityCheckPassed', type: 'int', location: 'body' },
    { field: 'quantityPackaged', type: 'int', location: 'body' },
    { field: 'exportedDate', type: 'date', location: 'body' },
    { field: 'passFIDate', type: 'date', location: 'body' }
  ]),
